...
/*
    PA0  - TIM5_CH1  - DMA(1, 2, 6)
    PA1  - TIM5_CH2  - DMA(1, 4, 6)
    PA2  - TIM5_CH3  - DMA(1, 0, 6)
    PA3  - TIM5_CH4  - DMA(1, 1, 6)
    PE9  - TIM1_CH1  - DMA(2, 3, 6)
    PE11 - TIM1_CH2  - DMA(2, 2, 6)
    PE13 - TIM1_CH3  - DMA(2, 6, 6)
    PE14 - TIM1_CH4  - DMA(2, 4, 6)
    PD12 - TIM4_CH1  - NO DMA
    PD13 - TIM4_CH2  - NO DMA
    PD14 - TIM4_CH3  - NO DMA
    PD15 - TIM4_CH4  - NO DMA
    PB5  - TIM3_CH2  - DMA(1, 5, 5)
    PB10 - TIM2_CH3  - NO DMA
    PB9  - TIM11_CH1 - NO DMA
*/
